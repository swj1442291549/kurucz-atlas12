...
C
    ...
    1 TABLOG(I)=10.**((I-16384)*.001)
     ...
     1FORM='UNFORMATTED',RECORDTYPE='FIXED',
     1RECORDSIZE=2,ACCESS='DIRECT')
...
c     iwlbytes(3)=onebyte
 ...
 3334 FORMAT(' FIRST LINE IS        1','   WL',F12.4)
      ...
      LENGTHFILE=65912356
c     file length of h2obig
c      LENGTHFILE=382876999-1000
...
c
   ...
   19 NELION=534
      ...
      GFLOG=(IGFLOG-16384.5D0)/1000.D0
c      print*,wlvac,elo,gflog
C     reduce gf values by factor of 4 for testing
C      CONGF=CONGF/4.0 
