...
C      REAL*8 ASYNTH,ALINEC,TITLE,TEFF,GLOG,IDMOL,MOMASS
      ...
      OPEN(UNIT=1,file='fort.221',STATUS='NEW',FORM='UNFORMATTED')
      OPEN(UNIT=2,file='fort.222',STATUS='NEW',FORM='UNFORMATTED')
      OPEN(UNIT=3,file='fort.223',STATUS='NEW',FORM='UNFORMATTED')
      OPEN(UNIT=4,file='fort.224',STATUS='NEW',FORM='UNFORMATTED')
